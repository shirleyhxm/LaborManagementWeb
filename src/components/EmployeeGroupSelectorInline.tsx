...
export function EmployeeGroupSelectorInline({
  selectedGroups,
  onChange,
  disabled = false,
          ...
          <Popover open={isOpen} onOpenChange={setIsOpen}>
            ...
            <PopoverContent className="w-72" align="start">
              <div className="space-y-4">
                <div>
                  <h4 className="font-medium mb-3 text-sm">Select Groups</h4>
                  <div className="space-y-2 max-h-48" style={{ overflow: "auto" }}>
                    {groups.length > 0 ? (
                      groups.map((group) => (
                        ...
                        >
                          <Checkbox
                            id={`inline-group-${group.name}`}
                            checked={selectedGroups.includes(group.name)}
                            onCheckedChange={() => handleToggleGroup(group.name)}
                            disabled={disabled}
                          />
                          <Label
                            htmlFor={`inline-group-${group.name}`}
                ...
                <div className="border-t pt-4">
                  ...
                  <div className="flex gap-2">
                    ...
                    <Button
                      ...
                      disabled={!newGroupName.trim() || isCreating || disabled}
                    >
