...
export const enGB: DeepPartial<TranslationBundle> = {
  ...
  schedule: {
    ...
    businessHoursAddInterval: 'Add hours',
    businessHoursRemoveInterval: 'Remove these hours',
    businessHoursProblem: {
      empty: 'An open day needs at least one set of hours.',
      zeroLength: 'Opening and closing time are the same.',
      wrapNotLast: 'Only the last set of hours can run past midnight.',
      overlap: 'These hours overlap or are out of order.',
    },
